...
// Copyright (c) 2014 The MelonCoin developers
...
void StakeMiner(CWallet *pwallet)
{
    ...
    RenameThread("madoocoin-stakeminer");
...
void static MadoocoinMiner(CWallet *pwallet)
{
    ...
    try { loop {
        ...
        {
            printf("MadoocoinMiner : no more PoW blocks\n");
            return;
        }

        IncrementExtraNonce(pblock, pindexPrev, nExtraNonce);

        printf("Running MadoocoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("MadoocoinMiner terminated\n");
        throw;
    }
}

void GenerateMadoocoins(bool fGenerate, CWallet* pwallet)
{
